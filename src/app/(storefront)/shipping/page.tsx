    ...
    <PolicyPage
      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            "Every order gets an order number in the form SBD-22082026-12345 — the date it was placed, then a serial. Use it on the Track order page, or open the order from your account.",
